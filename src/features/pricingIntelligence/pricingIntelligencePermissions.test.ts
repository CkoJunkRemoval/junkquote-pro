...
describe("pricing intelligence permissions and presentation",()=>{
  ...
  it("limits pages and exports to owner and admin roles",()=>{expect(page).toContain('requireCompanyModulePage("pricingIntelligence")');expect(route).toContain('requireCompanyRole("Owner","Admin")');expect(page).not.toContain('"Crew"');});
