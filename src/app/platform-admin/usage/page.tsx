...
export default async function UsagePage() {
  await requirePlatformAdminPage("platform_admin.usage_viewed"); const data = await getPlatformUsage();
  return <PlatformAdminShell active="/platform-admin/usage"><h2 className="text-2xl font-bold">Aggregate usage</h2>
