...
export default async function ConversionsPage({ searchParams }: { searchParams: Promise<{ period?: string; from?: string; to?: string }> }) {
  ...
  const data = await getPlatformConversions(platformRange(period, query.from, query.to));
