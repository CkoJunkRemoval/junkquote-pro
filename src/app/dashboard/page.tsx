...
export default async function DashboardPage({ searchParams }: { searchParams: Promise<Record<string, string | string[] | undefined>> }) {
  ...
  const [analytics, accuracy, options, schedule, invoices] = await Promise.all([getPricingAnalytics(companyId), getSmartPricingAccuracy(companyId, filters), getSmartPricingFilterOptions(companyId), getJobScheduleSummary(companyId), getInvoiceDashboardSummary(companyId)]);
  return (
    <AppLayout>
